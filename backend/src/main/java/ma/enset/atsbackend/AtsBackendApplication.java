...
import ma.enset.atsbackend.service.JobDescriptionServiceImpl;
...
public class AtsBackendApplication {
    ...
    @Bean
    CommandLineRunner commandLineRunner(RecruiterRepository recruiterRepository,
                                        CandidateRepository candidateRepository,
                                        JobDescriptionRepository jobDescriptionRepository,
                                        ApplicationRepository applicationRepository,
                                        JobDescriptionServiceImpl jobDescriptionService
...
//            allApplications.forEach(System.out::println);
            ...
            List<JobDescription> jobDesc = jobDescriptionService.findJobDesc();

            jobDesc.forEach(System.out::println);
        };
    }
